...
class reactive_follow_gap:
    def __init__(self):
        ...
        self.velocity = [1,2,3]#rospy.get_param("/reactive/velocity")
        self.steer_lim = [15,25]#rospy.get_param("/reactive/steer_angle_limits")

        
        self.kp = 0.7	#0.7#rospy.get_param("/reactive/kp")
        self.kd = 0.0 	#0#rospy.get_param("/reactive/kd")
        self.ki = 0.0 	#0#rospy.get_param("/reactive/ki")
